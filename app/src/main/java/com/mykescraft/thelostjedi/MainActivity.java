...
public class MainActivity extends AppCompatActivity {
    ...
    public void ok(View v){
        ...
        String introductionText = "Hello " + name + " Padawan!\nYou\'ve lost in a dark forest. You have to answer 7 questions correctly, and you will find the way out of the forest. Let\'s start it!\nMay the force be with you!";
        introduction.setText(introductionText);
        introduction.setTextColor(Color.parseColor("#FFFF8D"));
